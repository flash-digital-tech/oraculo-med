...
if 'authentication_status' in st.session_state and st.session_state['authentication_status']:
    ...
    permissao_usuario = {
        "admin": ["Apresentação", "DOUTOR MED", "Chat Demo", "Criar Cliente","Criar Parceiro", "Parceiro Stripe", "Financeiro", "Link de Pagamento", \
                  "Webhook","Assinaturas","Split de Pagamentos",],
        "parceiro": ["Apresentação", "DOUTOR MED", "Chat Demo","Criar Cliente","Assinaturas", "Link de Pagamento"],
